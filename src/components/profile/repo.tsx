...
export const Repo = ({
  ...
  return (
    <div className="p-1 rounded-md border hover:bg-primary delay-75 duration-150">
      <div className="flex h-full w-auto items-center p-3 gap-3 rounded-md bg-secondary text-sm">
